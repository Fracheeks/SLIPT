...
This project demonstrates how to safely connect a **3.3 V solar panel** to an Apollo3 Blue ADC input (e.g., A0) to measure its output voltage under varying light conditions.

## Hardware Setup
- Solar panel positive → Top resistor (R2) → A0  
- A0 → Bottom resistor (R1) → GND (Apollo3 Blue ground)  
...
### Simplified Wiring
Solar Panel + ──[R2=22kΩ]──> A0  
A0 ──[R1=33kΩ]──> GND  

> Ensure the solar panel’s negative terminal is connected to the Apollo3 Blue GND.
